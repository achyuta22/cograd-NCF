  ...
  return (
    <section className="bg-gradient-to-b from-blue-50 to-teal-100 text-gray-900 py-8">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        {/* Square Boxes */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-8 mb-4">
          <div
            ...
            className={`relative bg-gradient-to-br from-teal-200 to-teal-400 p-4 md:p-8 rounded-lg shadow-lg transition-shadow duration-300 flex items-center justify-center cursor-pointer ${
              showCore ? "ring-4 ring-teal-300" : ""
            }`}
          >
            <div className="flex itmes-center text-center flex-col">
          ...
          <div
            ...
            className={`relative bg-gradient-to-br from-blue-200 to-blue-400 p-4 md:p-8 rounded-lg shadow-lg transition-shadow duration-300 flex items-center justify-center cursor-pointer ${
              showNonCore ? "ring-4 ring-blue-300" : ""
            }`}
          >
            <div className="flex itmes-center text-center flex-col">
              <h3 className="text-xl md:text-3xl font-semibold text-teal-900">
        ...
        {/* Core Areas Section */}
        {showCore && (
          <div className="bg-gradient-to-r from-teal-50 to-teal-100 py-8 md:py-12 px-4 md:px-6 rounded-lg mb-16 shadow-lg">
        ...
        {showNonCore && (
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 py-8 md:py-12 px-4 md:px-6 rounded-lg shadow-lg">
            <div className="max-w-4xl mx-auto relative">
              ...
              <div className="flex flex-col md:flex-row items-start justify-between gap-6 md:gap-8">
                ...
                {/* Image */}
                <div className="relative w-full md:w-1/2 mt-6 md:mt-0 md:ml-6 flex justify-center">
                  <img
                    src={noncore}
                    alt="Non-Core Areas"
