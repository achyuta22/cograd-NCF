        ...
        <div class="flex flex-wrap gap-6 justify-center">
          ...
          <div class="relative w-full sm:w-1/2 lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <p class="text-gray-700">Education in Interdisciplinary Areas</p>
            </div>
          </div>
          ...
          <div class="relative w-full sm:w-1/2 lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <p class="text-gray-700">Vocational Education</p>
            </div>
          </div>
          ...
          <div class="relative w-full sm:w-1/2 lg:w-1/3 bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-4">
              ...
              <p class="text-gray-700">Subjects in Grade 11 and 12 </p>
            </div>
          </div>
        </div>
      </section>
