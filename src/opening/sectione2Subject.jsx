...
const CapacityBuildingSubjectsPage = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center py-10">
      ...
      <div className="container mx-auto p-4 grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-6">
          <h2 className="text-2xl font-bold mb-4">
            Capacity Building in The World Around Us, Art Education, Vocational Education, Physical Education and Well-being, and Interdisciplinary Areas
          </h2>
