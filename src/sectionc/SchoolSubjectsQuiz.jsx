...
const SchoolSubjectQuiz = () => {
  ...
  const questions = [
    {
      question: 'Which of the following best describes the areas of education that focus on integrating multiple disciplines and preparing students for practical skills and specialized knowledge?',
      options: [
        { id: 1, text: 'Education in Interdisciplinary Areas', isCorrect: true },
  ...
  return (
    <div className="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 min-h-screen flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        <h2 className="text-2xl font-bold mb-6 text-center text-blue-700">Quiz: School Subjects</h2>
